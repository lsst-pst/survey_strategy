...
config.sky_region.selections[0].maximum_limit=2.8

# Minimum limit (units=degrees) for field selection.
config.sky_region.selections[0].minimum_limit=-62.5

# Type of coordinate to select.
config.sky_region.selections[0].limit_type='Dec'
...
config.filters['g'].num_visits=105
...
# The number of requested visits for the filter.
config.filters['i'].num_visits=240
...
# The number of requested visits for the filter.
config.filters['r'].num_visits=240
...
# The number of requested visits for the filter.
config.filters['u'].num_visits=75
...
# Darkest magnitude limit for filter.
config.filters['y'].dark_limit=21.0

# Brightest magnitude limit for filter.
config.filters['y'].bright_limit=16.5
...
# The number of requested visits for the filter.
config.filters['y'].num_visits=210
...
# The number of requested visits for the filter.
config.filters['z'].num_visits=210
...
config.scheduling.max_num_targets=500
...
config.sky_exclusion.selections[0]=lsst.sims.ocs.configuration.proposal.selection.Selection()
# Maximum limit (units=degrees) for field selection.
config.sky_exclusion.selections[0].maximum_limit=10.0

# Minimum limit (units=degrees) for field selection.
config.sky_exclusion.selections[0].minimum_limit=0.0

# Type of coordinate to select.
config.sky_exclusion.selections[0].limit_type='GP'

# Boundary limit (units=degrees) for a sloping envelope selection.
config.sky_exclusion.selections[0].bounds_limit=90.0
