...
All members of the scientific community interested in LSST science\footnote{Note, there is no 
...
that is observed in extended sequences. 
...
\item A survey strategy allowing more overall visits by making each visit shorter: each visit being 20 sec long with a single exposure per visit in $g$, $r$, $i$, $z$ and $y$, and 40 sec visits in the $u$ band (and another similar survey with fewer visits, but with exposures of 40 sec and 60 sec, respectively). These variable visit times XXX
