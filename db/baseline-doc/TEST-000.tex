...
% colossus\_2371 & \opsim v4 with all new features turned off (reproduce minion\_1016) \\
% colossus\_2327 & Only group restriction added. \\
% astro-lsst-01\_2013 & HA bonus = 0.5, HA_max = 3 \\
% astro-lsst-01\_2021 & HA bonus = 0.5, HA_max = 6 \\
% colossus\_2028 & HA bonus = 0.05, HA_max = 6 \\
% colossus\_2399 & HA bonus = 0.5, HA_max = 6 \\
% colossus\_2378 & HA bonus = 0.8, HA_max = 8 \\
\end{tabular}
\end{center}
\label{default}
\end{table}
