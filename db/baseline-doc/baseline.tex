...
\setDocAbstract{%
We present an update to the baseline simulated survey, created using \opsim v4. The last \opsim baseline simulated survey was minion\_1016, produced in 2016 using \opsim v3. The changes in the new baseline run include updates to the sky brightness, significant changes in the underlying opsim scheduling software, and the addition of new scheduler parameters. 
}
