...
config.name='SouthCelestialPole'
...
config.sky_region.selections[0].maximum_limit=-62.5

# Minimum limit (units=degrees) for field selection.
config.sky_region.selections[0].minimum_limit=-90.0
...
# Brightest magnitude limit for filter.
config.filters['u'].bright_limit=21.0
