...
MENTION uniqueness of LSST instrument as an extra plus 

It is inevitable that some science drivers will be in conflict. The Project and the Science Advisory Commiitee
will make the proposal ranking process transparent to the maximum extent possible. 
...
selected for the final survey (plausible but not prescriptive range is 5-10). 

POINT OUT THAT SCIENCE needs to be matched to 10 sq.deg. field 
