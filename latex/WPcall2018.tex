...
technical feasibility for further analysis. These criteria are discussed in Section~\ref{sec:ranking}. 

The input from the submitted white papers will be used to design multiple
options in observing strategies and a Project team will generate a series of
...
survey strategies, and how the resulting simulated surveys are performing in respect to their submitted performance metrics.
...
Comprehensive simulated survey strategies available & Late 2019 \\
Survey Strategy Committee (SSC) established & Early 2020 \\
Advisory report by Project to SSC & Early 2020 \\
...
survey strategy, the main survey takes about 86\% of the time. 
