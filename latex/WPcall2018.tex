...
fully define the use of the remaining 10-20\% of available time, distributed among a variety of 
`mini surveys' (including the so-called `Deep Drilling fields' and `Target of Opportunity' programs).
...
the four primary LSST science themes must remain the cornerstones of the LSST survey.  This document
is a solicitation for white papers to help plan these aspects of the LSST survey strategy. 
