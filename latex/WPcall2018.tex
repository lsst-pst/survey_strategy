...
The deadline for these white papers is November 29, 2018.
}
...
exposures, the so-called snaps (2x15s visits). While 2x15s visits enable search for very rapid variability,
and help with cosmic ray rejection, there are compelling technical arguments to change to 
single exposure 30 second visits, with observing efficiency being the main argument. Arguments for retaining the
2x15s visits would be very useful in further optimization of the main survey strategy. 
\end{itemize}
...
%samples the full azimuthal distribution of TNOs, crucial for understanding the different 
%dynamical families in which they fall, and would improve the light curve sampling and completeness
%of asteroid populations in the inner Solar System.
