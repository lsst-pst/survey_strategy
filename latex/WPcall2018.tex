...
must be undertaken hand-in-hand with the community. We seek science-driven input for cadence 
properties such as per-bandpass imaging depth, the sky coverage, temporal coverage, and observing
rules. There are no specific limitations on what kind of science programs will be considered, except that 
the primary four LSST science themes remain the cornerstones of the LSST survey and must be
maintained. We are soliciting white papers to help plan these aspects of the LSST 
survey strategy. 
...
require about 90\% of the observing time; the use of the remaining time in mini surveys is not constrained in the SRD.
...
Within this boundary, the fraction of galaxies is only a few percent (due to heavy flux extinction 
