...
will be based on the following considerations\footenote{The PST is expected to review these ranking criteria before the call for white papers is published.}: 
\begin{itemize}
