...
additional surveys are not yet finalized.
...
\begin{itemize}
\item The main ``wide-fast-deep'' survey covers $\sim$18,000 deg$^2$ of sky within equatorial declination
...
consists of back-to-back 15 sec exposures, for a total of 30 sec of on-sky exposure time.} 
per field are acquired in each night, every three to four nights throughout the period the field is visible in each year. Each
...
\item The North Ecliptic Spur mini survey covers the area from $\delta = +2^\circ$ up to $10^\circ$ north of the Ecliptic plane
and is intended to observe the entire Ecliptic plane for purposes of inventorying the Solar System. This area is observed on
a schedule similar to the main survey, although with a smaller total number of visits per field.
\item The Galactic Plane mini survey covers the central portion of the Galactic plane which is not included in the main survey, 
although at a much reduced rate and with a smaller total number of observations per field (30 visits per field and per filter). 
There is no requirement for pairs of visits in each night in this area.
\item The South Celestial Pole mini survey covers the region south of the main survey, to the South Celestial Pole. 
This mini survey is observed with a strategy similar to the Galactic Plane mini survey, with 30 visits per field per filter, 
and without requiring pairs of visits. 
...
please see Appendix~\ref{sec:surveys}). 
...
arXiv:astro-ph/050404) show that to the depth of $r=27.5$ there are about 6 billion
